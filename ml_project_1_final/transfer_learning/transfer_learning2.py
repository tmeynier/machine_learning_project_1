...
drop = Dropout(0.2)(t)
dense_1 = Dense(1, activation=activations.sigmoid, name="dense_2")(drop)
...
model2.fit(X , Y, epochs=1000, batch_size=64, verbose=2, callbacks=callbacks_list, validation_split = 0.1)  
